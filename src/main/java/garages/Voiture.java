...
public class Voiture {
	...
	public void entreAuGarage(Garage g) throws Exception {
		// Et si la voiture est déjà dans un garage ?
                if (estDansUnGarage()){
                    throw new Exception("La voiture ne doit pas être déjà dans un garage");
                }
	...
	public Set<Garage> garagesVisites() {
            ...
            for (int i = 0; i< myStationnements.size(); i++){
                listeGarage.add(myStationnements.get(i).getGarage());
            }
            return listeGarage;
        }
	...
	public boolean estDansUnGarage() {
		...
		// Vrai si le dernier stationnement est en cours
                ...
                return false;
                }else return myStationnements.get(myStationnements.size()-1).estEnCours();
	}
